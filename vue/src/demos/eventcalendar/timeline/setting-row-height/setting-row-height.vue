...
<template>
  ...
  >
    <template #resource="resource">
      <div class="md-timeline-row-height-cont" v-if="!resource.children">
        <div class="md-timeline-row-height-name">{{ resource.name }}</div>
        <div class="md-timeline-row-height-title">{{ resource.title }}</div>
        <img class="md-timeline-row-height-avatar" :src="resource.img" />
      </div>
      <div v-if="resource.children">{{ resource.name }}</div>
    </template>
  </MbscEventcalendar>
</template>
