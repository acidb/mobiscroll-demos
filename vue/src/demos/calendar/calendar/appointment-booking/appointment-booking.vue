...
const multiple = ['dyndatetime(y,m,11)', 'dyndatetime(y,m,16)', 'dyndatetime(y,m,17)']
...
function handlePageLoadingSingle(event) {
...
function handlePageLoadingDatetime(event) {
...
function handlePageLoadingMultiple(event) {
...
function getDatetimes(d, callback) {
  let invalid = []
  let labels = []
