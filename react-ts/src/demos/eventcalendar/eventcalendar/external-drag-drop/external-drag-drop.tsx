...
const App: React.FC = () => {
  ...
  const [draggableMeeting, setDraggableMeeting] = React.useState<any>();
  const [draggableOrientation, setDraggableOrientation] = React.useState<any>();
  const [draggableBlank, setDraggableBlank] = React.useState<any>();
