...
const App: React.FC = () => {
    ...
    const getPrices = (d: Date, callback: any) => {
        ...
        getJson('https://trial.mobiscroll.com/getprices/?year=' + d.getFullYear() + '&month=' + d.getMonth(), (bookings: any) => {
    ...
    const getDatetimes = (d: Date, callback: any) => {
        ...
        getJson('https://trial.dev.mobiscroll.com/getbookingtime/?year=' + d.getFullYear() + '&month=' + d.getMonth(), (bookings) => {
