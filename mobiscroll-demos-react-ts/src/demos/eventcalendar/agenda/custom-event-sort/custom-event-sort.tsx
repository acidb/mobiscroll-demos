...
function App() {
  ...
  const customEventOrder = useCallback((event: MbscCalendarEvent) => (event.accepted ? 1 : -1), []);

  return <Eventcalendar view={myView} data={myEvents} eventOrder={customEventOrder} />;
}
export default App;
