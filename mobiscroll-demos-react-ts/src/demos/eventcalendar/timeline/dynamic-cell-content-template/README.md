...
[cellTemplate](https://docs.mobiscroll.com/react/eventcalendar/timeline#template-cellTemplate)
option,
:::
:::framework{only="vue"}
[cell](https://docs.mobiscroll.com/react/eventcalendar/timeline#slot-cell)
slot,
:::
:::framework{only="react"}
[renderCell](https://docs.mobiscroll.com/react/eventcalendar/timeline#renderer-renderCell)
function,
:::
