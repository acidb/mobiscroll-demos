...
[headerTemplate](https://docs.mobiscroll.com/react/eventcalendar/timeline#template-headerTemplate)
option,
:::
:::framework{only="vue"}
[header](https://docs.mobiscroll.com/react/eventcalendar/timeline#slot-header)
slot,
:::
:::framework{only="react"}
[renderHeader](https://docs.mobiscroll.com/react/eventcalendar/timeline#renderer-renderHeader)
function,
:::
...
:::framework{only="angular"}
[eventTemplate](https://docs.mobiscroll.com/react/eventcalendar/timeline#template-eventTemplate)
option,
:::
:::framework{only="vue"}
