...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/react-ts/scheduler/conditional-move-resize-drag-drop-fixed-event-length-fixed-to-resource#).