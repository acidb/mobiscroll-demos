...
const myWidth = ref('small')
const showResources = ref('on')
...
const myResEvents: MbscCalendarEvent[] = [
...
<template>
  <MbscPage cssClass="mds-full-height">
    <div class="mbsc-flex-col mds-full-height">
      <MbscSegmentedGroup cssClass="mbsc-flex-none" v-model="myWidth">
        <MbscSegmented value="small">50px</MbscSegmented>
        <MbscSegmented value="medium">100px</MbscSegmented>
        <MbscSegmented value="large">150px</MbscSegmented>
      </MbscSegmentedGroup>

      <MbscSegmentedGroup cssClass="mbsc-flex-none" v-model="showResources">
        <MbscSegmented value="on">With resources</MbscSegmented>
        <MbscSegmented value="off">Without resources</MbscSegmented>
      </MbscSegmentedGroup>

      <MbscEventcalendar
        :view="myView"
        :cssClass="'mds-col-width-' + myWidth"
        :data="showResources === 'on' ? myResEvents : myEvents"
        :resources="showResources === 'on' ? myResources : []"
        groupBy="date"
      />
    </div>
  </MbscPage>
