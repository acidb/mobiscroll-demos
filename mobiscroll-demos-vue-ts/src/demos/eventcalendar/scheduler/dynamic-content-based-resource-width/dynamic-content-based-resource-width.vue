...
const icons: { [key: string]: { title: string; svg: string } } = {
  office: {
    title: 'In office',
...
<template>
  ...
  <MbscEventcalendar :data="myEvents" groupBy="date" :resources="myResources" :view="myView">
    <template #resource="resource">
      <div
        class="mds-variable-res-col-name mbsc-flex mbsc-align-items-center mbsc-justify-content-center"
      >
        {{ resource.name }}
      </div>
      <div class="mds-variable-res-col-icons">
        <div
          v-for="icon in getIcons(resource)"
          v-html="icon.svg"
          class="mds-variable-res-col-icon"
          :key="icon.title"
          :title="icon.title"
        ></div>
      </div>
...
<style>
.mds-variable-res-col-small {
  width: 70px;
}

.mds-variable-res-col-medium {
  width: 100px;
}

.mds-variable-res-col-large {
  width: 130px;
}

.mds-variable-res-col-name {
  height: 40px;
  font-size: 14px;
}

.mds-variable-res-col-icons {
  padding-top: 8px;
}

.mds-variable-res-col-icon {
