...
const myClass = ref('my-col-width-small')
const showResources = ref('show')

const myResEvents = ref<MbscCalendarEvent[]>([
...
const myResources2 = ref<MbscResource[]>([])
...
function toggleResources() {
  ;[myResources.value, myEvents.value] = showResources.value
    ? [myResources2.value, myResEvents.value]
    : [[], []]
}
</script>
...
<template>
  <MbscPage>
    <MbscSegmentedGroup v-model="myClass">
      <MbscSegmented value="my-col-width-small">50px</MbscSegmented>
      <MbscSegmented value="my-col-width-medium">100px</MbscSegmented>
      <MbscSegmented value="my-col-width-large">150px</MbscSegmented>
    </MbscSegmentedGroup>
    <MbscSegmentedGroup v-model="showResources" @change="toggleResources">
      <MbscSegmented value="show">With resources</MbscSegmented>
      <MbscSegmented value="hide">Without resources</MbscSegmented>
    </MbscSegmentedGroup>
    <MbscEventcalendar
      :cssClass="myClass"
      :data="myResEvents"
