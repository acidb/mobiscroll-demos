...
const visibleEvents = computed(() =>
  showResources.value === 'show' ? myResEvents.value : myEvents.value
)
const visibleResources = computed(() => (showResources.value === 'show' ? myResources.value : []))
</script>
...
<template>
  <MbscPage>
    ...
    <MbscSegmentedGroup v-model="showResources">
