...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/timeline/navigate-view-from-external-calendar#).
...
The Datepicker updates the `selectedDate` option of the Timeline in its @change event, while the Timeline updates the datepicker value from its @selected-date-change event.
