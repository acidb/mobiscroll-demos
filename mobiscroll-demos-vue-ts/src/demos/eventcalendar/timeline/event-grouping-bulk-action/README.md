...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/timeline/event-grouping-bulk-action#).
...
suffix: keeping the controls integrated into the timeline header. The @if (pagemode == PageMode.Angular) { [resourceTemplate option](https://docs.mobiscroll.com/vue/eventcalendar/timeline#template-resourceTemplate) } else if (pagemode == PageMode.Vue) { [resource slot](https://docs.mobiscroll.com/vue/eventcalendar/timeline#slot-resource) } else { [renderResource function](https://docs.mobiscroll.com/vue/eventcalendar/timeline#renderer-renderResource) } adapts the resource column accordingly, displaying employee avatars and job titles in assignee view, and work type color indicators in type view.
:::framework{only="angular"}
[headerTemplate](https://docs.mobiscroll.com/vue/eventcalendar/timeline#template-headerTemplate)
option,
:::
:::framework{only="vue"}
[header](https://docs.mobiscroll.com/vue/eventcalendar/timeline#slot-header)
slot,
:::
:::framework{only="react"}
[renderHeader](https://docs.mobiscroll.com/vue/eventcalendar/timeline#renderer-renderHeader)
function,
:::
...
:::framework{only="angular"}
[eventTemplate](https://docs.mobiscroll.com/vue/eventcalendar/timeline#template-eventTemplate)
option,
:::
:::framework{only="vue"}
[timelineEvent](https://docs.mobiscroll.com/vue/eventcalendar/timeline#slot-timelineEvent)
slot,
:::
:::framework{only="react"}
[renderTimelineEvent](https://docs.mobiscroll.com/vue/eventcalendar/timeline#renderer-renderTimelineEvent)
function,
:::
:::framework{only="javascript"}
[renderTimelineEvent](https://docs.mobiscroll.com/vue/eventcalendar/timeline#renderer-renderTimelineEvent)
