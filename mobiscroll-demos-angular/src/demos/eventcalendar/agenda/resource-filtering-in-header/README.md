...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/agenda/resource-filtering-in-header#).
...
- **Want to style and reorder the header?** [Take a look at the previous example →](https://demo.mobiscroll.com/angular/agenda/customizing-calendar-header#)

## Related demos

- [Take a look at the previous example →](https://demo.mobiscroll.com/angular/agenda/customizing-calendar-header#)
