...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/eventcalendar/load-events-from-google-calendar#).
...
Public calendars are read-only. If you are interested in syncing private google calendars with read/write/delete access, [check out this example](https://demo.mobiscroll.com/angular/eventcalendar/sync-events-google-calendar#).
