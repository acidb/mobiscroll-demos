...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/eventcalendar/event-data-structure#).
...
- `start` - Sets the start date and time for the event. It can be a js date object, ISO date string or moment.js object. [Learn about date formats](https://demo.mobiscroll.com/angular/eventcalendar/date-object-ISO-8601-moment#)
...
- `recurring` - Configures the recurring rules for the event. [Learn about recurring events](https://demo.mobiscroll.com/angular/eventcalendar/recurring-events#)
