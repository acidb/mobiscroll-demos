...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/eventcalendar/external-drag-drop-sortable-dragula#).
...
Set up a container as draggable with the `mbsc-draggable` directive. Pass a skeleton event definition through the `dragData` option which will be added to the event calendar on drop. If omitted, a default event will be created.
...
For details, and option lists see the [Third-party dragging support](https://docs.mobiscroll.com/angular/eventcalendar/drag-and-drop#third-party-dragging-support) section in the documentation

- **Looking for external drag into a scheduler?** [Check out this example &#8594;](https://demo.mobiscroll.com/angular/scheduler/external-drag-drop-sortable-dragula#)

## Related demos

- [Check out this example &#8594;](https://demo.mobiscroll.com/angular/scheduler/external-drag-drop-sortable-dragula#)
