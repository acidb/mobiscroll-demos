...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/eventcalendar/customizing-header#).
...
- **Want to add a filter to the header?** [Check out the next example &#8594;](https://demo.mobiscroll.com/angular/eventcalendar/resource-filtering-in-header#)

## Related demos

- [Check out the next example &#8594;](https://demo.mobiscroll.com/angular/eventcalendar/resource-filtering-in-header#)
