...
- **Interested in adding recurrence configuration?** [Check out the next example &#8594;](https://demo.mobiscroll.com/angular/eventcalendar/recurring-event-add-edit-dialog#)
