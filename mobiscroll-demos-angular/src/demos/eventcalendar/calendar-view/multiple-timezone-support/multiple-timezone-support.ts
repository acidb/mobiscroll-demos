...
import { dayjsTimezone, MbscCalendarEvent, MbscEventcalendarOptions, MbscModule, setOptions /* localeImport */ } from '@mobiscroll/angular';
...
@Component({
  selector: 'app-eventcalendar-multiple-timezone-support',
