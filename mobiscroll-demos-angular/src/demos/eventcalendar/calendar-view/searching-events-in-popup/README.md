...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/eventcalendar/searching-events-in-popup#).

## Demo description

Use the available real estate in the calendar header to add event search. With the [templating capabilities of the header](https://demo.mobiscroll.com/angular/eventcalendar/customizing-header#)
you can easily add a search box and use a separate [agenda](https://demo.mobiscroll.com/angular/agenda/#) instance to show the search results.
...
[inline agenda](https://demo.mobiscroll.com/angular/eventcalendar/searching-events-in-sidebar#) instead of a dropdown.
