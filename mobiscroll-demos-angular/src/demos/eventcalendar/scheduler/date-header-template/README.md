...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/scheduler/date-header-template#).

## Demo description

Customize the date headers of the scheduler by adding relevant content, labels or completely change how they look. Use the `schedulerDayTemplate` option for setting up a custom date header template.
