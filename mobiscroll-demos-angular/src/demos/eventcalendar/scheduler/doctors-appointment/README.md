...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/scheduler/doctors-appointment#).
...
Enabling [advanced validation](https://demo.mobiscroll.com/angular/scheduler/time-off-blocked-ranges#) and combining that with the
[drag & drop between the calendar and external list](https://demo.mobiscroll.com/angular/scheduler/external-drag-drop-sortable-dragula#)
