...
[Events can be filtered in real time](https://demo.mobiscroll.com/angular/scheduler/resource-filtering-in-header#) so using an agenda view for the search results is an easy choice.
