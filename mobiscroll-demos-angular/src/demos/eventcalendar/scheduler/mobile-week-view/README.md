...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/scheduler/mobile-week-view#).
...
The screen can easily become crowded so it might be a good idea to think in a responsive implementation - [daily schedule on small screens and weekly schedule on bigger screens](https://demo.mobiscroll.com/angular/scheduler/responsive-day-week-schedule#).

- **Interested in daily schedule?** [Explore this example &#8594;](https://demo.mobiscroll.com/angular/scheduler/mobile-day-view#)
