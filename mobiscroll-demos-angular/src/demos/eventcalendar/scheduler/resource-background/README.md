...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/scheduler/resource-background#).
...
- **Interested in highlighting date ranges only?** [Explore this example &#8594;](https://demo.mobiscroll.com/angular/scheduler/colored-cell-background#)

## Related demos

- [Explore this example &#8594;](https://demo.mobiscroll.com/angular/scheduler/colored-cell-background#)
