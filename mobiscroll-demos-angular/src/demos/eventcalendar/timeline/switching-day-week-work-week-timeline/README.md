...
- **Want to see how to set other views?** [Check out this example for switching views &#8594;](https://demo.mobiscroll.com/angular/scheduler/switching-calendar-scheduler-agenda#)
