...
[headerTemplate](https://docs.mobiscroll.com/angular/eventcalendar/timeline#template-headerTemplate)
option,
:::
:::framework{only="vue"}
[header](https://docs.mobiscroll.com/angular/eventcalendar/timeline#slot-header)
slot,
:::
:::framework{only="react"}
[renderHeader](https://docs.mobiscroll.com/angular/eventcalendar/timeline#renderer-renderHeader)
function,
:::
...
:::framework{only="angular"}
[eventTemplate](https://docs.mobiscroll.com/angular/eventcalendar/timeline#template-eventTemplate)
option,
:::
:::framework{only="vue"}
[timelineEvent](https://docs.mobiscroll.com/angular/eventcalendar/timeline#slot-timelineEvent)
slot,
:::
:::framework{only="react"}
[renderTimelineEvent](https://docs.mobiscroll.com/angular/eventcalendar/timeline#renderer-renderTimelineEvent)
function,
:::
:::framework{only="javascript"}
[renderTimelineEvent](https://docs.mobiscroll.com/angular/eventcalendar/timeline#renderer-renderTimelineEvent)
