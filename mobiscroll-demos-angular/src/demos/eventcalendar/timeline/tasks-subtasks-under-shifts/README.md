...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/timeline/tasks-subtasks-under-shifts#).
...
- **Do you want to learn about the event ordering?** [Learn more about it in the documentation &#8594;](https://docs.mobiscroll.com/angular/eventcalendar/timeline#event-order)

## Related demos

- [Learn more about it in the documentation &#8594;](https://docs.mobiscroll.com/angular/eventcalendar/timeline#event-order)
