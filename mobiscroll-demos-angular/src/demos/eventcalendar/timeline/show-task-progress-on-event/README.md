...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/timeline/show-task-progress-on-event#).
...
Using the event templating capabilities, it is possible to render a live slider that reacts on hover and enables updating the progress inline. Use the [timelineEventTemplate](https://docs.mobiscroll.com/angular/eventcalendar/timeline#template-timelineEventTemplate)
option to customize the template and adjust it to your needs.
