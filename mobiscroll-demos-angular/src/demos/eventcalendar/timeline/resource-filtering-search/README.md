...
[resourceHeaderTemplate](https://docs.mobiscroll.com/angular/eventcalendar/timeline#template-resourceHeaderTemplate)
option
:::
:::framework{only="vue"}
[resourceHeader](https://docs.mobiscroll.com/angular/eventcalendar/timeline#slot-resourceHeader)
slot
:::
:::framework{only="react"}
[renderResourceHeader](https://docs.mobiscroll.com/angular/eventcalendar/timeline#renderer-renderResourceHeader)
function
:::
