...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/timeline/show-summaries-aggregates-for-resource-groups#).
...
- **Variable event height is an experimental feature.** [Learn more about it in the documentation &#8594;](https://docs.mobiscroll.com/angular/eventcalendar/timeline#variable-event-height)
