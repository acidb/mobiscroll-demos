...
@Component({
  selector: 'app-36-hour-rolling-window-aircraft-view',
  standalone: true,
  imports: [CommonModule, MbscModule],
  templateUrl: './36-hour-rolling-window-aircraft-view.html',
  styleUrls: ['./36-hour-rolling-window-aircraft-view.css'],
})
