...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/timeline/calendar-zoom#).
...
[zoomLevels](https://docs.mobiscroll.com/angular/eventcalendar/timeline#view-timeline-zoomLevels)
