...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/calendar/quarter-year-view#).

## Demo description

Create a calendar with quarter views that can be navigated quarter by quarter or switch to a year view on the fly. Show any relevant information with [labels or add background colors](https://demo.mobiscroll.com/angular/calendar/dots-colors-labels#) to days along with [week counters](https://demo.mobiscroll.com/angular/calendar/month-change-direction-week-numbers-outer-days#).
