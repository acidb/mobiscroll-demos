...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/calendar/single-select#).
...
- **Looking for multiple select?** [See how to enable multi-select →](https://demo.mobiscroll.com/angular/calendar/multiple-select#)

## Related demos

- [See how to enable multi-select →](https://demo.mobiscroll.com/angular/calendar/multiple-select#)
