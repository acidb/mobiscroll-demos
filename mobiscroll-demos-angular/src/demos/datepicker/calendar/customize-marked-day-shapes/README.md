...
- **What else can you use to add extra information to the day cells?** [Learn how to add labels and color days →](https://demo.mobiscroll.com/angular/calendar/dots-colors-labels#)

## Related demos

- [Learn how to add labels and color days →](https://demo.mobiscroll.com/angular/calendar/dots-colors-labels#)
