...
You can change the `timeFormat` or rely on the formats coming from the [locale settings](https://demo.mobiscroll.com/angular/datetime/localization#).

- **Interested in date selection?** [Learn how to set up a date-only picker →](https://demo.mobiscroll.com/angular/datetime/date-picker#)

## Related demos

- [Learn how to set up a date-only picker →](https://demo.mobiscroll.com/angular/datetime/date-picker#)
