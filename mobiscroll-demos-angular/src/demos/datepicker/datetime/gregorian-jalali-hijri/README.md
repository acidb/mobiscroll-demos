...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/datetime/gregorian-jalali-hijri#).
...
- **Interested in localization?** [Explore this example →](https://demo.mobiscroll.com/angular/datetime/localization#)

## Related demos

- [Explore this example →](https://demo.mobiscroll.com/angular/datetime/localization#)
