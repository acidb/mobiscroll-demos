...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/range/mobile-desktop-usage#).
...
Use it on an existing form field, custom input, `ion-input` or use it on Mobiscroll form fields. You can also embed it directly into your page.
