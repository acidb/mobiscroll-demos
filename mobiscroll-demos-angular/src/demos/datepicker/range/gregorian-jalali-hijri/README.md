...
- **Interested in localization?** [Explore this example →](https://demo.mobiscroll.com/angular/range/localization#)

## Related demos

- [Explore this example →](https://demo.mobiscroll.com/angular/range/localization#)
