...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/range/rtl-right-to-left#).
...
- **Explore the different locales** [Check out this example →](https://demo.mobiscroll.com/angular/range/localization#)

## Related demos

- [Check out this example →](https://demo.mobiscroll.com/angular/range/localization#)
