...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/popup/add-event-modal#).
...
Check out the [different display modes](https://demo.mobiscroll.com/angular/popup/mobile-desktop-display#) and play around with the different configurations.
