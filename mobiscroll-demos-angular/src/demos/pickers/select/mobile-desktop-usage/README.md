...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/angular/select/mobile-desktop-usage#).
...
Use it on an existing form field, custom input, native select, `ion-input` or use it on Mobiscroll form fields. You can also embed it directly into your page.
...
- **Handle different screen sizes by setting it up responsively** [Check out the responsive demo →](https://demo.mobiscroll.com/angular/select/responsive#)

## Related demos

- [Check out the responsive demo →](https://demo.mobiscroll.com/angular/select/responsive#)
