...
- **Interested in add/edit screens for events?** [Check out how the segmented can be used in an event form →](https://demo.mobiscroll.com/angular/eventcalendar/create-read-update-delete-CRUD#)

## Related demos

- [Check out how the segmented can be used in an event form →](https://demo.mobiscroll.com/angular/eventcalendar/create-read-update-delete-CRUD#)
