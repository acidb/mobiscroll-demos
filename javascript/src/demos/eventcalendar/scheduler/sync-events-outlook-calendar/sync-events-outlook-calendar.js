...
export default {
  init() {
    ...
    var loginButton = document.getElementById('demo-outlook-cal-sign-in');
    var logoutButton = document.getElementById('demo-outlook-cal-sign-out');

    var calendarList = document.getElementById('demo-outlook-cal-list');
    ...
    var cont = document.getElementById('demo-outlook-calendar-cont');
    ...
    var inst = mobiscroll.eventcalendar('#demo-outlook-calendar', {
      view: {
        schedule: { type: 'week' },
      },
