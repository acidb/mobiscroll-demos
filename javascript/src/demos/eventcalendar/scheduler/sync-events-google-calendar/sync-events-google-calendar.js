...
export default {
  ...
  init() {
    ...
    var loginButton = document.getElementById('demo-google-cal-sign-in');
    var logoutButton = document.getElementById('demo-google-cal-sign-out');

    var calendarList = document.getElementById('demo-google-cal-list');
    var loggedOutCont = document.getElementById('demo-logged-out-cont');
    var loggedInCont = document.getElementById('demo-logged-in-cont');
...
<div mbsc-page class="md-sync-events-google-cont">
    <div class="md-sync-events-google-menu">
        <div id="demo-logged-out-cont">
            <div class="mbsc-form-group-inset mbsc-align-center">
                ...
                <button mbsc-button id="demo-google-cal-sign-in" class="md-sync-events-google-button mbsc-button-block">Sync my google calendars</button>
            </div>
        </div>
        <div id="demo-logged-in-cont" style="display:none">
            ...
            <div class="mbsc-form-group-inset">
                <button mbsc-button id="demo-google-cal-sign-out" class="md-sync-events-google-button mbsc-button-block">Log out of my account</button>
            </div>
        </div>
    </div>
