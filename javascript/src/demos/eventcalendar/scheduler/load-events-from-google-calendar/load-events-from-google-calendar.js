    ...
    var calInst = mobiscroll.eventcalendar('#demo-google-cal', {
      ...
      renderHeader: function () {
        return (
          ...
          '<label>Month<input mbsc-segmented type="radio" name="view" value="month" class="md-google-calendar-view"></label>' +
          '<label>Week<input mbsc-segmented type="radio" name="view" value="week" class="md-google-calendar-view" checked></label>' +
