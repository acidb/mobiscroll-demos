...
export default {
  init() {
    ...
    mobiscroll.eventcalendar('#demo-hour-header-template', {
      view: {
        timeline: {
          type: 'day',
        },
    ...
    mobiscroll.eventcalendar('#demo-day-header-template', {
      view: {
        timeline: {
          type: 'month',
        },
    ...
    mobiscroll.eventcalendar('#demo-week-header-template', {
      view: {
        timeline: {
          type: 'week',
    ...
    mobiscroll.eventcalendar('#demo-month-header-template', {
      view: {
        timeline: {
          type: 'month',
    ...
    mobiscroll.eventcalendar('#demo-quarter-header-template', {
      view: {
        timeline: {
          type: 'year',
    ...
    mobiscroll.eventcalendar('#demo-year-header-template', {
      view: {
        timeline: {
          type: 'year',
