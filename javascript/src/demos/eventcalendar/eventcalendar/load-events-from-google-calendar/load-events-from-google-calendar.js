...
export default {
  init() {
    ...
    var calInst = mobiscroll.eventcalendar('#demo-google-cal', {
      ...
      renderHeader: function () {
        return (
          ...
          '<label>Month<input mbsc-segmented type="radio" name="view" value="month" class="md-google-calendar-view" checked></label>' +
          '<label>Week<input mbsc-segmented type="radio" name="view" value="week" class="md-google-calendar-view"></label>' +
          '<label>Day<input mbsc-segmented type="radio" name="view" value="day" class="md-google-calendar-view"></label>' +
          '<label>Agenda<input mbsc-segmented type="radio" name="view" value="agenda" class="md-google-calendar-view"></label>' +
          '</div>' +
    ...
    document.querySelectorAll('.md-google-calendar-view').forEach(function (elm) {
