    ...
    var inst = mobiscroll.eventcalendar('#demo-mobile-month-view', {
      ...
      renderLabel: function (data) {
        return (
          ...
          data.original.color +
          ';color:#000" class="multi-day-event my-label">' +
          data.original.title +
          '</div>'
        );
        // if (data.isMultiDay) {
        ...
        // } else {
        //     return '<div class="single-day-event-dot" style="background:' + data.original.color + '"></div>' +
        //         '<div class="single-day-event" style="color:#000">' + data.original.title + '</div>';
        // }
      },
