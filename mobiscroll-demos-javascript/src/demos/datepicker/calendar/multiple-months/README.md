...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/calendar/multiple-months#).
...
You can dynamically change the number of months or [switch between month and week view](https://demo.mobiscroll.com/javascript/calendar/week-to-month#) without the need for recycling the whole component.
