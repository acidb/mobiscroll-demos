...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/calendar/localization#).
...
- **Locale selector** The left side of the calendar shows a "Set localization to" label with a dropdown. That opens a list of available locales that updates the date picker calendar localization.
