...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/calendar/gregorian-jalali-hijri#).
...
- **Interested in localization?** [Explore this example →](https://demo.mobiscroll.com/javascript/calendar/localization#)

## Related demos

- [Explore this example →](https://demo.mobiscroll.com/javascript/calendar/localization#)
