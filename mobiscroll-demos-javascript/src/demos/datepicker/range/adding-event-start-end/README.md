...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/range/adding-event-start-end#).
...
- **Interested in an event calendar solution?** [Check out the event calendar →](https://demo.mobiscroll.com/javascript/eventcalendar/#)
