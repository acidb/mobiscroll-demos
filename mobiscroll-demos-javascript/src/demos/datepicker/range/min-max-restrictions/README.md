...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/range/min-max-restrictions#).
...
Values can be passed as [JS date objects, ISO date strings or Moment.js objects](https://demo.mobiscroll.com/javascript/range/date-object-ISO-8601-moment#).

- **Looking to invalidate more dates/times?** [Discover how to disable specific values →](https://demo.mobiscroll.com/javascript/range/disabled-invalid-values#)

## Related demos

- [Discover how to disable specific values →](https://demo.mobiscroll.com/javascript/range/disabled-invalid-values#)
