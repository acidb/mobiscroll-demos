...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/range/localization#).
...
- **Locale selector** The left side of the calendar shows a "Set localization to" label with a dropdown. That opens a list of available locales that updates the date range picker calendar localization.
...
- **Multi-language date range picker UIs** Apps that need the same date range picker experience in multiple languages and regional formats.
