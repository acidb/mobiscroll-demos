...
- **Interested in localization?** [Explore this example →](https://demo.mobiscroll.com/javascript/range/localization#)

## Related demos

- [Explore this example →](https://demo.mobiscroll.com/javascript/range/localization#)
