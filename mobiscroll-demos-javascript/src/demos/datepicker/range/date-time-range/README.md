...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/range/date-time-range#).
...
- `calendar` - will render a calendar view for date range selection ([explore date ranges](https://demo.mobiscroll.com/javascript/range/date-range#))
- `date` - will render a date scroller or dropdown for date range selection  ([explore date ranges](https://demo.mobiscroll.com/javascript/range/date-range#))
- `time` - will render a time picker for range selection ([explore time ranges](https://demo.mobiscroll.com/javascript/range/time-range#))
- `timegrid` - will render a time grid for range selection ([explore time range selection](https://demo.mobiscroll.com/javascript/range/time-range#))
