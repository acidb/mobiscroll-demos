...
- **Want to add a filter to the header?** [Check out the next example →](https://demo.mobiscroll.com/javascript/agenda/resource-filtering-in-header#)

## Related demos

- [Check out the next example →](https://demo.mobiscroll.com/javascript/agenda/resource-filtering-in-header#)
