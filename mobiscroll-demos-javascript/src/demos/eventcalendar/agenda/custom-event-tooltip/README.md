...
In case of md-boostrap, you can add the tooltip directive to the [custom event template](https://demo.mobiscroll.com/javascript/agenda/full-event-customization#)
