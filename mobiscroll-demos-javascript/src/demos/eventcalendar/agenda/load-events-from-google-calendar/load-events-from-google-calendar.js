...
export default {
  ...
  init() {
    ...
    function showLoader() {
      loader = loader || document.getElementById('demo-google-cal-loader');
      if (loader) {
    ...
    var calendar = mobiscroll.eventcalendar('#demo-google-cal', {
      view: {
        calendar: { type: 'week' },
        agenda: { type: 'week' },
      },
    ...
    document.querySelectorAll('.mds-google-cal-view').forEach(function (elm) {
