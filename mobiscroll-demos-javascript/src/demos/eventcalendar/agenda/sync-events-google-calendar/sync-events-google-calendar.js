...
export default {
  ...
  init() {
    ...
    function isLoading(loading) {
      loader = loader || document.getElementById('demo-sync-google-cal-loader');
      if (loader) {
    ...
    var inst = mobiscroll.eventcalendar('#demo-sync-google-cal', {
      view: {
        agenda: { type: 'month' },
      },
    ...
    var btnSignIn = document.getElementById('demo-sync-google-cal-sign-in');
    var btnSignOut = document.getElementById('demo-sync-google-cal-sign-out');
    var btnCalPopup = document.getElementById('demo-sync-google-cal-popup-btn');
    var btnCalToday = document.getElementById('demo-sync-google-cal-today');
    var calendarList = document.getElementById('demo-sync-google-cal-list');

    var popup = mobiscroll.popup('#demo-sync-google-cal-popup', {
      anchor: btnCalPopup,
    ...
    calendarList.addEventListener('change', function (ev) {
      if (ev.target.classList.contains('mds-google-cal-switch')) {
