...
export default {
  ...
  init() {
    ...
    var myCalendar = mobiscroll.eventcalendar('#demo-control-the-column-width', {
    ...
    document.querySelectorAll('#toggle-resources input').forEach(function (input) {
    ...
    document.querySelectorAll('input[name="mds-custom-width-options"]').forEach(function (input) {
      input.addEventListener('change', function () {
        myCalendar.setOptions({ cssClass: this.value });
        myCalendar.navigate(new Date());
      });
    });
  },
...
<div mbsc-segmented-group>
  <label>
    <input type="radio" mbsc-segmented name="mds-custom-width-options" value="my-col-width-small" checked>
    50px
  </label>  
  <label>
  <input type="radio" mbsc-segmented name="mds-custom-width-options" value="my-col-width-medium">
    100px
    </label>
  <label>
  <input type="radio" mbsc-segmented name="mds-custom-width-options" value="my-col-width-large">
    150px
    </label>
  </div>
  <div mbsc-segmented-group id="toggle-resources">
  <label>
    <input type="radio" mbsc-segmented name="mds-custom-width-res-toggle" value="on" checked>
    With resources
  </label>
  <label>
    <input type="radio" mbsc-segmented name="mds-custom-width-res-toggle" value="off">
    Without resources
  </label>
</div>
