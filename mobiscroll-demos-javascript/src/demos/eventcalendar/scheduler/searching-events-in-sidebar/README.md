...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/scheduler/searching-events-in-sidebar#).
...
[Events can be filtered in real time](https://demo.mobiscroll.com/javascript/scheduler/resource-filtering-in-header#) so using an agenda view for the search results is an easy choice.
