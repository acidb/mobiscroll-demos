...
export default {
  ...
  init() {
    ...
    var cellDate = document.getElementById('demo-cell-summary-date');
    var cellEventNr = document.getElementById('demo-cell-summary-events');
    var cellInvalidNr = document.getElementById('demo-cell-summary-invalid');
    var cellColorNr = document.getElementById('demo-cell-summary-colors');
    ...
    mobiscroll.eventcalendar('#demo-show-cell-summary-on-hover', {
      ...
      onCellHoverIn: function (args) {
        ...
        cellEventNr.textContent = args.events ? args.events.length : 0;
        cellInvalidNr.textContent = args.invalids ? args.invalids.length : 0;
        cellColorNr.textContent = args.colors ? args.colors.length : 0;
    ...
    var tooltip = mobiscroll.popup('#demo-cell-summary-popup', {
      display: 'anchored',
      showOverlay: false,
      touchUi: false,
      scrollLock: false,
