...
export default {
  ...
  init() {
    ...
    mobiscroll.eventcalendar('#demo-variable-res-col', {
      // drag,
      data: myEvents,
      groupBy: 'date',
      ...
      renderResource: function (resource) {
        ...
        resourceIcons.forEach(function (icon) {
          iconsHtml += '<div class="mds-variable-res-col-icon" title="' + icon.title + '">' + icon.svg + '</div>';
        });

        return (
          '<div class="mds-variable-res-col-name mbsc-flex mbsc-align-items-center mbsc-justify-content-center">' +
          resource.name +
          '</div>' +
  ...
  markup: `
<div id="demo-variable-res-col"></div>
  `,
  // eslint-disable-next-line es5/no-template-literals
  css: `
