...
export default {
  ...
  init() {
    ...
    mobiscroll.eventcalendar('#demo-content-dependent-resource-widths', {
      // context,
      // drag,
      data: myEvents,
      groupBy: 'date',
      renderResource: function (resource) {
        ...
        return '<div>' + '<div class="mds-var-col-resource-name">' + resource.name + '</div>' + '<div>' + iconsHtml + '</div>' + '</div>';
      },
  ...
  markup: `
<div id="demo-content-dependent-resource-widths"></div>
  `,
  // eslint-disable-next-line es5/no-template-literals
  css: `
