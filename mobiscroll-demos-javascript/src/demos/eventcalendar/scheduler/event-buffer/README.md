...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/scheduler/event-buffer#).
...
- **Looking to customize event buffers?** [Check out the templating capabilities &#8594;](https://demo.mobiscroll.com/javascript/scheduler/customizing-events#)
