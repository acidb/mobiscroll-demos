...
export default {
  ...
  init() {
    ...
    var container = document.querySelector('.mds-scheduler-event-drop-assign-attendees');
    ...
    var calendar = mobiscroll.eventcalendar('#demo-scheduler-event-drop-assign-attendees', {
      view: {
        scheduler: {
          type: 'week',
          startDay: 1,
