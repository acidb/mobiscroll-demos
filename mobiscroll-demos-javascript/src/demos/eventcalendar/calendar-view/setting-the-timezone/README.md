...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/eventcalendar/setting-the-timezone#).
...
specifically for the event using the `timezone` property of the [event data](https://demo.mobiscroll.com/javascript/eventcalendar/event-data-structure#).
...
- **Enable switching the timezone in the UI?** [Learn how to dynamically change timezones &#8594;](https://demo.mobiscroll.com/javascript/eventcalendar/multiple-timezone-support#)
