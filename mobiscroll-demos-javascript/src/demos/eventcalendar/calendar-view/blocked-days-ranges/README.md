...
- To disable weekends, use the [recurring object](https://demo.mobiscroll.com/javascript/eventcalendar/recurring-events#) - `recurring: { repeat: 'weekly', weekDays: 'SA,SU' }`
