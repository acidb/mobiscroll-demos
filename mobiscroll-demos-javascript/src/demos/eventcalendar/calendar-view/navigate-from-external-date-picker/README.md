...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/eventcalendar/navigate-from-external-date-picker#).
...
The Datepicker calls the `navigate` method of the Calendar in its `onChange` event,
