...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/eventcalendar/switching-day-week-month-view#).
...
- **Interested in the agenda?** [How to render an agenda instead of a calendar &#8594;](https://demo.mobiscroll.com/javascript/agenda/daily-weekly-monthly-annual-agenda#)

## Related demos

- [How to render an agenda instead of a calendar &#8594;](https://demo.mobiscroll.com/javascript/agenda/daily-weekly-monthly-annual-agenda#)

## Implementation instructions

- Define three view configs controlled by a state variable:
