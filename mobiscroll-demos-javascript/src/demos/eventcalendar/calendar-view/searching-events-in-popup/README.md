...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/eventcalendar/searching-events-in-popup#).

## Demo description

Use the available real estate in the calendar header to add event search. With the [templating capabilities of the header](https://demo.mobiscroll.com/javascript/eventcalendar/customizing-header#)
you can easily add a search box and use a separate [agenda](https://demo.mobiscroll.com/javascript/agenda/#) instance to show the search results.
...
[Events can be filtered in real time](https://demo.mobiscroll.com/javascript/eventcalendar/resource-filtering-in-header#) so using an agenda view for the search results is an easy choice.
...
[inline agenda](https://demo.mobiscroll.com/javascript/eventcalendar/searching-events-in-sidebar#) instead of a dropdown.
