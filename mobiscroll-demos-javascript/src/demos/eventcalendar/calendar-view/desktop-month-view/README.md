...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/eventcalendar/desktop-month-view#).
...
The number of visible labels are determined by the available space and the ones that don't fit will be shown in a popover. To save vertical space you can [show all events in a popover](https://demo.mobiscroll.com/javascript/eventcalendar/event-popover#).

- **Interested to see how the event calendar looks on smaller screens?** [Check out the previous demo &#8594;](https://demo.mobiscroll.com/javascript/eventcalendar/mobile-month-view#)

## Related demos

- [Check out the previous demo &#8594;](https://demo.mobiscroll.com/javascript/eventcalendar/mobile-month-view#)
