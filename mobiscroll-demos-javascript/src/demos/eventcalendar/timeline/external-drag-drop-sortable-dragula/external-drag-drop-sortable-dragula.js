  ...
  init() {
    ...
    mobiscroll.eventcalendar('#demo-drag-drop-sortable-dragula', {
      ...
      onEventCreated: function (args) {
        ...
        var elm = document.getElementById('mds-event-' + args.event.id);
        if (elm) {
          elm.remove();
        }
      },
      ...
      onResourceCreated: function (args) {
        ...
        var elm = document.getElementById('mds-resource-' + args.resource.id);
        if (elm) {
          elm.remove();
        }
      },
    ...
    mobiscroll.dropcontainer('#external-drop-cont', {
      onItemDrop: function (args) {
        if (args.data) {
          ...
          mobiscroll.draggable('#mds-event-' + event.id, {
            dragData: event,
          });
        }
      },
    ...
    var sortableTaskInstance = new Sortable(document.getElementById('demo-sortable-task-list'), {
      animation: 150,
      forceFallback: true,
      onStart: function (e) {
        draggedTask = e.item;
    ...
    var drake1 = dragula([document.getElementById('demo-dragula-task-list')]);
    ...
    <div class="mbsc-col-sm-3 mds-drag-drop-sort-container-wrapper mds-full-height">
      ...
      <div class="mbsc-flex">
        <div class="mbsc-col-sm-6 mbsc-flex-col" >
          <div id="external-drop-cont" class="mds-drag-drop-sort-container mbsc-flex-col mbsc-flex-1-0">
            <div class="mbsc-txt-muted mds-third-party-list-title">Event list</div>
            <div id="mds-event"  class="mbsc-flex-col mbsc-flex-1-0">
