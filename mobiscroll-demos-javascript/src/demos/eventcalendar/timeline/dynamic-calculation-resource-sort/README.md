...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/timeline/dynamic-calculation-resource-sort#).
...
[snackbar](https://demo.mobiscroll.com/javascript/forms/notifications#)
