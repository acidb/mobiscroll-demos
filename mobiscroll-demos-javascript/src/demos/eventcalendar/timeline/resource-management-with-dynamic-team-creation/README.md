...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/timeline/resource-management-with-dynamic-team-creation#).
...
- **Looking for external event drag & drop?** [Check out this example &#8594;](https://demo.mobiscroll.com/javascript/timeline/external-drag-drop-sortable-dragula#)
