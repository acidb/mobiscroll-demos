...
Using the event templating capabilities, it is possible to render a live slider that reacts on hover and enables updating the progress inline. Use the [renderTimelineEvent](https://docs.mobiscroll.com/javascript/eventcalendar/timeline#renderer-renderTimelineEvent)
