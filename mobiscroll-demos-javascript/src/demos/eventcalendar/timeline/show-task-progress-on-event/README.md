...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/timeline/show-task-progress-on-event#).
...
[timelineEventTemplate](https://docs.mobiscroll.com/javascript/eventcalendar/timeline#template-timelineEventTemplate)
option
:::
:::framework{only="vue"}
