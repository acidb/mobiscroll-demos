...
export default {
  ...
  init() {
    ...
    var calendar = mobiscroll.eventcalendar('#demo-employee-shifts-calendar', {
      clickToCreate: true,
      dragToCreate: false,
      dragToResize: false,
      dragToMove: true,
    ...
    var addEditPopup = mobiscroll.popup('#demo-employee-shifts-popup', {
      display: 'bottom',
    ...
    var eventStartEndPicker = mobiscroll.datepicker('#demo-popup-shift-dates', {
      controls: ['time'],
      display: 'anchored',
      select: 'range',
