...
- **Interested in the time grid?** [Check out how you can configure the vertical time rendering &#8594;](https://demo.mobiscroll.com/javascript/scheduler/show-hide-hours-days#)
