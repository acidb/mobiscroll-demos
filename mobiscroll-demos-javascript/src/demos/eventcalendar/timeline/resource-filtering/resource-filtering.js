...
export default {
  ...
  init() {
    ...
    var calendarElm = document.getElementById('demo-filtering-calendar');
    var popupElm = document.getElementById('demo-filtering-popup');
    var resourceList = document.getElementById('demo-resource-list');
    ...
    calendarElm.addEventListener('input', function (event) {
      if (event.target.matches('#demo-search-input')) {
