...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/timeline/custom-range-view#).

## Demo description

The timeline comes with [built-in support for day, week, month and year views](https://demo.mobiscroll.com/javascript/timeline/multiple-days-weeks-months-quarters-years-variable-resolution#). For those situations where a custom range makes more sense, it is possible to override the calendar navigation component with a [range picker](https://demo.mobiscroll.com/javascript/range/date-filtering-with-predefined-ranges#).
