...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/timeline/timeline-resource-details-side-panel-footer#).
...
The occupancy percentages that can be seen for each day are set through the `renderDayFooter` in a similar way to the [day header templates](https://demo.mobiscroll.com/javascript/scheduler/custom-resource-header-template#).
...
The [initial order](https://docs.mobiscroll.com/javascript/eventcalendar/timeline#resource-order)
