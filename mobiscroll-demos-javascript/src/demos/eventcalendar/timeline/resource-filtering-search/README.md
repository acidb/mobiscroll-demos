...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/timeline/resource-filtering-search#).
...
[resourceHeaderTemplate](https://docs.mobiscroll.com/javascript/eventcalendar/timeline#template-resourceHeaderTemplate)
option
:::
:::framework{only="vue"}
[resourceHeader](https://docs.mobiscroll.com/javascript/eventcalendar/timeline#slot-resourceHeader)
slot
:::
:::framework{only="react"}
[renderResourceHeader](https://docs.mobiscroll.com/javascript/eventcalendar/timeline#renderer-renderResourceHeader)
function
:::
