...
When dealing with numerous resources, filtering and search are essential tools. Using the [renderResourceHeader](https://docs.mobiscroll.com/javascript/eventcalendar/timeline#renderer-renderResourceHeader)
