...
- **Interested in adding recurrence configuration?** [Check out this example &#8594;](https://demo.mobiscroll.com/javascript/eventcalendar/recurring-event-add-edit-dialog#)
