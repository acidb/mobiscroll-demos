  ...
  init() {
    ...
    mobiscroll.eventcalendar('#demo-drag-drop-bw-inst-first', {
      ...
      onPageLoaded: function () {
        if (!firstCalCont) {
          firstCalCont = document.querySelector('.md-drag-drop-bw-inst-first .mbsc-timeline-grid-scroll');
          firstCalCont.addEventListener('scroll', handleFirstScroll);
        }
      },
      ...
      onDestroy: function () {
        if (firstCalCont) {
          firstCalCont.removeEventListener('scroll', handleFirstScroll);
        }
      },
    });

    var secondCalendar = mobiscroll.eventcalendar('#demo-drag-drop-bw-inst-second', {
      view: {
        timeline: {
          type: 'day',
          size: 1,
      ...
      onPageLoaded: function () {
        if (!secondCalCont) {
          secondCalCont = document.querySelector('.md-drag-drop-bw-inst-second .mbsc-timeline-grid-scroll');
          secondCalCont.addEventListener('scroll', handleSecondScroll);
        }
      },
      onDestroy: function () {
        if (secondCalCont) {
          secondCalCont.removeEventListener('scroll', handleSecondScroll);
        }
      },
    });
  },
