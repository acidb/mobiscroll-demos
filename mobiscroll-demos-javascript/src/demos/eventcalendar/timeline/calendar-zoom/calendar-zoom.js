...
export default {
  ...
  init() {
    ...
    function handleZoom(zoom) {
      ...
      document.getElementById('demo-zoom-level-slider').value = zoomLevel;
      document.getElementById('demo-zoom-level-in').disabled = zoomLevel === 18;
      document.getElementById('demo-zoom-level-out').disabled = zoomLevel === 1;
    ...
    document.getElementById('demo-zoom-level-slider').addEventListener('input', function (ev) {
      handleZoom(+ev.target.value);
    });

    document.getElementById('demo-zoom-level-in').addEventListener('click', function () {
      handleZoom(zoomLevel + 1);
    });

    document.getElementById('demo-zoom-level-out').addEventListener('click', function () {
      handleZoom(zoomLevel - 1);
    });
