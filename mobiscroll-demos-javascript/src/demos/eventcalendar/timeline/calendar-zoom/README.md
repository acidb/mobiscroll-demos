...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/timeline/calendar-zoom#).
...
[zoomLevels](https://docs.mobiscroll.com/javascript/eventcalendar/timeline#view-timeline-zoomLevels)
