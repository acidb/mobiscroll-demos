...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/select/mobile-desktop-display#).
...
- **Want to see how to set up responsiveness?** [Check out the previous example →](https://demo.mobiscroll.com/javascript/select/responsive#)

## Related demos

- [Check out the previous example →](https://demo.mobiscroll.com/javascript/select/responsive#)
