...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/select/mobile-desktop-usage#).
...
- **Handle different screen sizes by setting it up responsively** [Check out the responsive demo →](https://demo.mobiscroll.com/javascript/select/responsive#)

## Related demos

- [Check out the responsive demo →](https://demo.mobiscroll.com/javascript/select/responsive#)
