...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/javascript/select/single-select#).
...
- **Looking for multiple select?** [Check out the next example →](https://demo.mobiscroll.com/javascript/select/multiple-select#)

## Related demos

- [Check out the next example →](https://demo.mobiscroll.com/javascript/select/multiple-select#)
