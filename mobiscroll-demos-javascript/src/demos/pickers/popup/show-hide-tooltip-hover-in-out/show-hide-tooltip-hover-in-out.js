...
export default {
  ...
  init() {
    ...
    var timer;
    var tooltipElm = document.getElementById('demo-event-tooltip-popup');
    var title = document.getElementById('demo-tooltip-event-title');
    var startDate = document.getElementById('demo-tooltip-event-start');
    var endDate = document.getElementById('demo-tooltip-event-end');
    ...
    mobiscroll.eventcalendar('#demo-event-tooltip-calendar', {
      ...
      onEventHoverIn: function (args) {
        ...
        startDate.textContent = formatDate('hh:mm A', new Date(event.start));
        endDate.textContent = formatDate('hh:mm A', new Date(event.end));
    ...
    var tooltip = mobiscroll.popup(tooltipElm, {
      display: 'anchored',
      showOverlay: false,
      width: 250,
    });
