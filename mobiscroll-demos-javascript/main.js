...
var themeSelect = mobiscroll.select('#mobiscroll-theme', {
  data: themes,
  touchUi: false,
...
var localeSelect = mobiscroll.select('#mobiscroll-locale', {
  data: locales,
  touchUi: false,
  onChange: function (args) {
    locale = args.value;
...
document.querySelectorAll('.mobiscroll-theme-variant').forEach(function (el) {
