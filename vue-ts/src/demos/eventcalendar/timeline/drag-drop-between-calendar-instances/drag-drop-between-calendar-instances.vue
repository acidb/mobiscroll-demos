...
const firstResources = ref<MbscResource[]>([
  {
    id: 1,
    name: 'Resource A'
  },
...
const secondResources = ref<MbscResource[]>([
  {
    id: 1,
    name: 'Resource A'
  },
...
const toastContext = ref<string>(null)
const toastMessage = ref<string>(null)
const isToastOpen = ref<boolean>(false)

function handleFirstCalEventCreated(args: MbscEventCreatedEvent) {
...
function handleSecondCalEventCreated(args: MbscEventCreatedEvent) {
  if (args.action === 'externalDrop') {
