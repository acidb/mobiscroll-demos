...
const markedDays: MbscCalendarMarked[] = [
...
const coloredDays: MbscCalendarColor[] = [
...
const labelDays: MbscCalendarLabel[] = [
      ...
      <div class="mbsc-row">
        <div class="mbsc-col-sm-12 mbsc-col-md-4">
          <div class="mbsc-form-group">
            ...
            <MbscDatepicker :controls="['calendar']" :marked="markedDays" display="inline" />
          </div>
        </div>
        <div class="mbsc-col-sm-12 mbsc-col-md-4">
          <div class="mbsc-form-group">
            <div class="mbsc-form-group-title">Colored days</div>
            <MbscDatepicker :controls="['calendar']" :colors="coloredDays" display="inline" />
          </div>
        </div>
        <div class="mbsc-col-sm-12 mbsc-col-md-4">
          <div class="mbsc-form-group">
            <div class="mbsc-form-group-title">Labels</div>
            <MbscDatepicker :controls="['calendar']" :labels="labelDays" display="inline" />
          </div>
        </div>
      </div>
    </div>
