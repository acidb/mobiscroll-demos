...
import { ref } from 'vue'
import { MbscSelect, MbscButton, MbscPage, setOptions /* localeImport */ } from '@mobiscroll/vue'
...
const mySelectValue = ref<string>('atl')
...
<template>
  <MbscPage>
      ...
      <div class="mbsc-form-group">
        <div class="mbsc-row">
          <div class="mbsc-col-12">
            ...
            <MbscSelect :data="myData" inputComponent="input" :inputProps="inputProps" />
          </div>
        </div>
      </div>
      <div class="mbsc-form-group">
    ...
    <div class="md-mobile-picker-inline">
      <MbscSelect :data="myData" display="inline" />
    </div>
  </MbscPage>
</template>
