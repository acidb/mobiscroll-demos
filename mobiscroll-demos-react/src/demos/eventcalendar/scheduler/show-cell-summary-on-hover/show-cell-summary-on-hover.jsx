...
function App() {
  ...
  const [cellEventNr, setCellEventNr] = useState(0);
  const [cellInvalidNr, setCellInvalidNr] = useState(0);
  const [cellColorNr, setCellColorNr] = useState(0);
  const [isTooltipOpen, setTooltipOpen] = useState(false);
  const [tooltipAnchor, setAnchor] = useState('');
