...
function App() {
  ...
  const [myResEvents, setResEvents] = useState([
  ...
  const [myResources2, setResources2] = useState([]);
  const [showResources, setShowResources] = useState('show');

  const [myClass, setClass] = useState('my-col-width-small');
  ...
  return (
    <Page>
      <SegmentedGroup value={myClass} onChange={(e) => setClass(e.target.value)}>
