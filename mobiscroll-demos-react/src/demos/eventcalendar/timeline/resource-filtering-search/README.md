...
[resourceHeaderTemplate](https://docs.mobiscroll.com/react/eventcalendar/timeline#template-resourceHeaderTemplate)
option
:::
:::framework{only="vue"}
[resourceHeader](https://docs.mobiscroll.com/react/eventcalendar/timeline#slot-resourceHeader)
slot
:::
:::framework{only="react"}
[renderResourceHeader](https://docs.mobiscroll.com/react/eventcalendar/timeline#renderer-renderResourceHeader)
function
:::
