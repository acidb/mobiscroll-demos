...
function Resource({ data, isDraggable }) {
  const [draggable, setDraggable] = useState();
...
function App() {
  ...
  const [dragulaResourceCont, setDragulaResourceCont] = useState();
  ...
  const [myDraggableResources, setDraggableResources] = useState([
    {
      id: 'draggable-1',
      name: 'Resource 1',
    },
  ...
  const [mySortableResources, setSortableResources] = useState([
    {
      id: 'sortable-1',
      name: 'Resource 5',
    },
  ...
  const [myDragulaResources, setDragulaResources] = useState([
    {
      id: 'dragula-1',
      name: 'Resource 9',
    },
