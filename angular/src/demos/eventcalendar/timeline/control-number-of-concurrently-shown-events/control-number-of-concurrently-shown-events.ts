...
import { setOptions, MbscCalendarEvent, MbscEventcalendarView, MbscResource /* localeImport */ } from '@mobiscroll/angular';
...
export class AppComponent {
  myEvents: MbscCalendarEvent[] = [
    ...
    // Resource 3
    { title: 'Webinar', start: new Date(year, month, day - 1, 8), end: new Date(year, month, day - 1, 16), color: '#43be5f', resource: 3 },
    {
