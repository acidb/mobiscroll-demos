...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/eventcalendar/external-drag-drop-sortable-dragula#).
...
For details, and option lists see the [Third-party dragging support](https://docs.mobiscroll.com/jquery/eventcalendar/drag-and-drop#third-party-dragging-support) section in the documentation

- **Looking for external drag into a scheduler?** [Check out this example &#8594;](https://demo.mobiscroll.com/jquery/scheduler/external-drag-drop-sortable-dragula#)

## Related demos

- [Check out this example &#8594;](https://demo.mobiscroll.com/jquery/scheduler/external-drag-drop-sortable-dragula#)
