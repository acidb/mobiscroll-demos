...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/eventcalendar/blocked-days-ranges#).
...
- To disable weekends, use the [recurring object](https://demo.mobiscroll.com/jquery/eventcalendar/recurring-events#) - `recurring: { repeat: 'weekly', weekDays: 'SA,SU' }`
