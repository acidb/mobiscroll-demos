...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/eventcalendar/searching-events-in-sidebar#).

## Demo description

Inline search can be easily implemented with the help of a separate [agenda](https://demo.mobiscroll.com/jquery/agenda/#) instance.
...
[agenda listed in a popup](https://demo.mobiscroll.com/jquery/eventcalendar/searching-events-in-popup#) instead of rendered inline.
