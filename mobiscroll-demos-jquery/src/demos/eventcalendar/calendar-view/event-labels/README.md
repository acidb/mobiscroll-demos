...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/eventcalendar/event-labels#).
...
- **Rather show events in a pop-over?** [Take a look at the next example &#8594;](https://demo.mobiscroll.com/jquery/eventcalendar/event-popover#)

## Related demos

- [Take a look at the next example &#8594;](https://demo.mobiscroll.com/jquery/eventcalendar/event-popover#)
