...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/eventcalendar/external-event-presets#).
...
- **Want to see how external presets look & feel for a scheduler?** [Check out this example &#8594;](https://demo.mobiscroll.com/jquery/scheduler/external-event-presets#)
