...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/scheduler/load-events-on-demand#).

## Demo description

The scheduler supports [remote](https://demo.mobiscroll.com/jquery/scheduler/load-events-from-remote-api#) and [local data sources](https://demo.mobiscroll.com/jquery/scheduler/load-inline-data#). Besides that, events can be populated on initialization or loaded on demand.
...
`onPageLoading`
::: lifecycle event to load the data runtime. You can [learn about lifecycle events](https://demo.mobiscroll.com/jquery/scheduler/event-hooks#) and places where to drop logic to customize the experience.
