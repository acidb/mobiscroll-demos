    ...
    $(function () {
      var myEvents = [
        ...
        },
        {
          ...
          end: 'dyndatetime(y,m,d+2,11,00)',
        },
        {
          id: 13,
          resource: 1,
          title: 'Feature Dev',
          start: 'dyndatetime(y,m,d-2,11,00)',
          end: 'dyndatetime(y,m,d-2,13,00)',
        },
        {
          id: 17,
          resource: 1,
          title: 'Performance Tuning',
          start: 'dyndatetime(y,m,d-7,14,00)',
        ...
        },
        {
          ...
          resource: 1,
          title: 'Code Audit',
          start: 'dyndatetime(y,m,d+5,10,00)',
        ...
        },
        {
          ...
          resource: 1,
          title: 'API Testing',
          start: 'dyndatetime(y,m,d-5,11,00)',
          end: 'dyndatetime(y,m,d-5,12,30)',
        },
        {
          id: 32,
          resource: 1,
          title: 'Database Cleanup',
          start: 'dyndatetime(y,m,d+3,14,00)',
        ...
        },
        {
          ...
          start: 'dyndatetime(y,m,d+7,13,00)',
        ...
        },
        {
          ...
          resource: 1,
          title: 'Code Review',
          start: 'dyndatetime(y,m,d+1,11,00)',
        ...
        },
        {
          ...
          resource: 3,
          title: 'Client Call',
          start: 'dyndatetime(y,m,d,9,00)',
          end: 'dyndatetime(y,m,d,10,00)',
        },

        {
          ...
          start: 'dyndatetime(y,m,d+1,14,00)',
          end: 'dyndatetime(y,m,d+1,15,30)',
        },

        {
          ...
          start: 'dyndatetime(y,m,d+2,16,00)',
        ...
        },
        {
          ...
          end: 'dyndatetime(y,m,d-1,12,00)',
        },
        {
          id: 12,
          resource: 3,
          title: 'Bug Report',
          start: 'dyndatetime(y,m,d-1,9,00)',
...

        {
          ...
          start: 'dyndatetime(y,m,d-2,10,00)',
        ...
        },
        {
          ...
          resource: 4,
          title: 'System Check',
          start: 'dyndatetime(y,m,d,13,00)',
          end: 'dyndatetime(y,m,d,14,00)',
        },
        {
          id: 5,
          resource: 4,
          title: 'Live Chat',
          start: 'dyndatetime(y,m,d+1,10,00)',
        ...
        },
        {
          ...
          end: 'dyndatetime(y,m,d+2,16,00)',
        },
        {
          id: 11,
          resource: 4,
          title: 'Support Training',
          start: 'dyndatetime(y,m,d-1,15,00)',
...

        {
          ...
          resource: 3,
          title: 'UI Bug Fix',
          start: 'dyndatetime(y,m,d-7,10,00)',
        ...
        },
        {
          ...
          start: 'dyndatetime(y,m,d-7,9,00)',
...

        {
          ...
          start: 'dyndatetime(y,m,d+7,15,00)',
          end: 'dyndatetime(y,m,d+7,16,30)',
        },
        {
          id: 22,
          resource: 4,
          title: 'System Maintenance',
          start: 'dyndatetime(y,m,d+7,10,30)',
          end: 'dyndatetime(y,m,d+7,12,00)',
        },
        ...
        },
        {
          ...
          resource: 4,
          title: 'Customer Demo',
          start: 'dyndatetime(y,m,d-5,14,00)',
          end: 'dyndatetime(y,m,d-5,15,00)',
        },

        {
          id: 27,
          resource: 3,
          title: 'Error Logging Review',
          start: 'dyndatetime(y,m,d+5,15,00)',
          end: 'dyndatetime(y,m,d+5,16,30)',
        },
        {
          id: 28,
          resource: 4,
          title: 'Escalated Issue',
          start: 'dyndatetime(y,m,d+5,13,00)',
          end: 'dyndatetime(y,m,d+5,14,00)',
        },
        {
          id: 29,
          resource: 1,
          title: 'Feature Testing',
          start: 'dyndatetime(y,m,d-3,9,00)',
        ...
        },
        {
          ...
          start: 'dyndatetime(y,m,d-3,14,30)',
          end: 'dyndatetime(y,m,d-3,16,00)',
        },
        {
          id: 31,
          resource: 4,
          title: 'Support Tickets',
          start: 'dyndatetime(y,m,d-3,11,00)',
