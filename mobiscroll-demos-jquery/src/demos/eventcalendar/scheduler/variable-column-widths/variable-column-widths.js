    ...
    $(function () {
      ...
      var myEvents = [
        ...
        },
        {
          ...
          start: 'dyndatetime(y, m, d + 4, 12, 0)',
          end: 'dyndatetime(y, m, d + 4, 13, 15)',
        },
        {
          id: 24,
          ...
          start: 'dyndatetime(y, m, d - 1, 10, 45)',
        ...
        },
        {
          ...
          resource: 1,
          title: 'DB Update',
          start: 'dyndatetime(y, m, d - 3, 11, 30)',
        ...
        },
        {
          ...
          resource: 1,
          title: 'Review',
          start: 'dyndatetime(y, m, d - 3, 14, 45)',
          end: 'dyndatetime(y, m, d - 3, 15, 30)',
        },
        {
          id: 43,
          resource: 4,
        ...
        },
        {
          ...
          resource: 1,
          title: 'Dev Update',
          start: 'dyndatetime(y, m, d - 4, 13, 15)',
          end: 'dyndatetime(y, m, d - 4, 13, 45)',
        },
        {
          id: 49,
          resource: 4,
          title: 'Client Call',
          start: 'dyndatetime(y, m, d - 5, 11, 30)',
        ...
        },
        {
          ...
          end: 'dyndatetime(y, m, d - 5, 14, 0)',
        },
        {
          id: 51,
          resource: 4,
          title: 'Code Check',
          start: 'dyndatetime(y, m, d - 5, 15, 30)',
        ...
        },
        {
          ...
          end: 'dyndatetime(y, m, d - 7, 10, 45)',
        },
        {
          id: 57,
          resource: 1,
          title: 'Team Sync',
          start: 'dyndatetime(y, m, d - 7, 13, 30)',
          end: 'dyndatetime(y, m, d - 7, 14, 30)',
        },
        {
          id: 58,
          resource: 3,
        ...
        },
        {
          ...
          end: 'dyndatetime(y, m, d - 7, 15, 15)',
        },
        {
          id: 61,
          resource: 4,
          title: 'Client Sync',
          start: 'dyndatetime(y, m, d - 7, 10, 45)',
        ...
        },
        {
          ...
          resource: 1,
          title: 'Team Sync',
          start: 'dyndatetime(y, m, d - 6, 13, 15)',
          end: 'dyndatetime(y, m, d - 6, 14, 15)',
        },
        {
          id: 63,
          resource: 3,
        ...
        },
        {
          ...
          title: 'Team Meeting',
          start: 'dyndatetime(y, m, d + 7, 9, 0)',
          end: 'dyndatetime(y, m, d + 7, 10, 15)',
        },
        {
          id: 66,
          resource: 4,
          title: 'Planning',
          start: 'dyndatetime(y, m, d + 7, 12, 30)',
          end: 'dyndatetime(y, m, d + 7, 13, 15)',
        },
        {
          id: 67,
          resource: 4,
          title: 'Quick Check',
          start: 'dyndatetime(y, m, d + 7, 15, 15)',
          end: 'dyndatetime(y, m, d + 7, 15, 45)',
        },
        {
          id: 68,
          resource: 3,
        ...
        },
        {
          ...
          resource: 3,
          title: 'Test Run',
          start: 'dyndatetime(y, m, d + 7, 11, 45)',
        ...
        },
        {
          ...
          title: 'Team Meet',
          start: 'dyndatetime(y, m, d + 6, 9, 30)',
          end: 'dyndatetime(y, m, d + 6, 10, 0)',
        },
        {
          id: 74,
          resource: 4,
          title: 'Strategy Session',
          start: 'dyndatetime(y, m, d + 6, 10, 0)',
          end: 'dyndatetime(y, m, d + 6, 10, 30)',
        },
        {
          id: 75,
          resource: 3,
          title: 'Test Review',
          start: 'dyndatetime(y, m, d + 6, 10, 15)',
        ...
        },
        {
          ...
          resource: 3,
          title: 'API Check',
          start: 'dyndatetime(y, m, d + 6, 11, 0)',
        ...
        },
        {
          ...
          resource: 3,
          title: 'Feature Test',
          start: 'dyndatetime(y, m, d + 6, 12, 45)',
          end: 'dyndatetime(y, m, d + 6, 13, 15)',
        },
        {
          id: 78,
        ...
        },
        {
          ...
          resource: 4,
          title: 'Code Check',
          start: 'dyndatetime(y, m, d + 5, 10, 45)',
          end: 'dyndatetime(y, m, d + 5, 11, 45)',
        },
        {
          id: 82,
          resource: 4,
      ...
      $('#demo-variable-column-widths')
        ...
        .eventcalendar({
          ...
          renderResource: function (resource) {
            ...
            if (resource.role === 'support') iconsHtml += supportSvg;
            if (resource.vacation) iconsHtml += vacationSvg;
            if (!resource.available) iconsHtml += availableSvg;
...
<div id="demo-variable-column-widths"></div>
  ...
  // eslint-disable-next-line es5/no-template-literals
  css: `
.mbsc-ios-dark .mds-var-col-svg, 
.mbsc-windows-dark .mds-var-col-svg, 
.mbsc-material-dark .mds-var-col-svg  {
  fill: white;
}
