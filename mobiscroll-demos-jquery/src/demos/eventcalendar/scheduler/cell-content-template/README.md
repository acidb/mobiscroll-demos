...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/scheduler/cell-content-template#).
...
[timeCellStep](https://docs.mobiscroll.com/jquery/eventcalendar/timeline#view-timeline-timeCellStep) option.
