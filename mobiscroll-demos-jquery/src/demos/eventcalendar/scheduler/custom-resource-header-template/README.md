...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/scheduler/custom-resource-header-template#).
...
- **Interested in displaying resource information on hover?** [Show details on hover &#8594;](https://demo.mobiscroll.com/jquery/timeline/display-resource-information-on-hover#)

## Related demos

- [Show details on hover &#8594;](https://demo.mobiscroll.com/jquery/timeline/display-resource-information-on-hover#)
