...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/agenda/customizing-calendar-header#).
...
- **Want to add a filter to the header?** [Check out the next example →](https://demo.mobiscroll.com/jquery/agenda/resource-filtering-in-header#)

## Related demos

- [Check out the next example →](https://demo.mobiscroll.com/jquery/agenda/resource-filtering-in-header#)
