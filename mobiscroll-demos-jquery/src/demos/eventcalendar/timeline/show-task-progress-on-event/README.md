...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/show-task-progress-on-event#).
...
[timelineEventTemplate](https://docs.mobiscroll.com/jquery/eventcalendar/timeline#template-timelineEventTemplate)
option
:::
:::framework{only="vue"}
