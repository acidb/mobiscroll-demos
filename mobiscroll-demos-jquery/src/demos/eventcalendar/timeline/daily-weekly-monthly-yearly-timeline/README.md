...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/daily-weekly-monthly-yearly-timeline#).
...
- **Interested in the time grid?** [Check out how you can configure the vertical time rendering &#8594;](https://demo.mobiscroll.com/jquery/scheduler/show-hide-hours-days#)
