...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/timeline-resource-details-side-panel-footer#).
...
The [initial order](https://docs.mobiscroll.com/jquery/eventcalendar/timeline#resource-order)
