...
Once the right perspective is selected, individual events are not rendered one by one. Using the [renderTimelineEvent](https://docs.mobiscroll.com/jquery/eventcalendar/timeline#renderer-renderTimelineEvent)
