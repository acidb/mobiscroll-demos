...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/dynamic-cell-content-template#).
...
See this
[configuration demo](https://demo.mobiscroll.com/jquery/timeline/multiple-days-weeks-months-quarters-years-variable-resolution#)
