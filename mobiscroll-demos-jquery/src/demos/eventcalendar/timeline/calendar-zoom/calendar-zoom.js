    ...
    $(function () {
          ...
          view: {
            timeline: {
              zoomLevels: {
                ...
                15: { type: 'year', size: 3, resolutionHorizontal: 'hour', timeCellStep: 30, timeLabelStep: 30, columnWidth: 'medium' },
                16: { type: 'year', size: 3, resolutionHorizontal: 'hour', timeCellStep: 30, timeLabelStep: 30, columnWidth: 'xxxlarge' },
                17: { type: 'year', size: 3, resolutionHorizontal: 'hour', timeCellStep: 15, timeLabelStep: 15, columnWidth: 'xxxlarge' },
                18: { type: 'year', size: 3, resolutionHorizontal: 'hour', timeCellStep: 5, timeLabelStep: 5, columnWidth: 'large' },
              },
            },
          },
      ...
      function handleZoom(zoom) {
        ...
        var refDates = {
          ...
          15: new Date(viewDate.getFullYear() - 1, 0, 1),
          16: new Date(viewDate.getFullYear() - 1, 0, 1),
          17: new Date(viewDate.getFullYear() - 1, 0, 1),
          18: new Date(viewDate.getFullYear() - 1, 0, 1),
        };
