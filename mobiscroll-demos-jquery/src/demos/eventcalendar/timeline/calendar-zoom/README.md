...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/calendar-zoom#).
...
[zoomLevels](https://docs.mobiscroll.com/jquery/eventcalendar/timeline#view-timeline-zoomLevels)
