...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/resource-management-with-dynamic-team-creation#).
...
`onResourceDelete` will be fired.
