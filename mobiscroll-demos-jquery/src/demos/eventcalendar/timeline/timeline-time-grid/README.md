...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/timeline-time-grid#).
...
- **Interested in the timeline view?** [Learn how to configure and customize the timeline &#8594;](https://demo.mobiscroll.com/jquery/timeline/#)
