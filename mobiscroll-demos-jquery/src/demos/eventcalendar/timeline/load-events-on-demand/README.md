...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/load-events-on-demand#).

## Demo description

The timeline supports [remote](https://demo.mobiscroll.com/jquery/timeline/load-events-from-remote-api#) and [local data sources](https://demo.mobiscroll.com/jquery/timeline/load-inline-data#). Besides that, events can be populated on initialization or loaded on demand.
...
`onPageLoading`
::: lifecycle event to load the data runtime. You can [learn about lifecycle events](https://demo.mobiscroll.com/jquery/timeline/event-hooks#) and places where to drop logic to customize the experience.
