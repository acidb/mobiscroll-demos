      ...
      var calInst = $('#demo-resource-drag-drop-reorder')
        ...
        .eventcalendar({
          ...
          data: [
            ...
            { title: 'Event 12', start: 'dyndatetime(y,m,23)', end: 'dyndatetime(y,m,28)', resource: 2, color: 'blue' },
            { title: 'Event 13', start: 'dyndatetime(y,m,25)', end: 'dyndatetime(y,m,29)', resource: 10, color: 'red' },
            { title: 'Event 14', start: 'dyndatetime(y,m,27)', end: 'dyndatetime(y,m,30)', resource: 9, color: 'yellow' },
            ...
            { title: 'Event 24', start: 'dyndatetime(y,m,17)', end: 'dyndatetime(y,m,21)', resource: 3, color: 'cyan' },
            ...
            { title: 'Event 28', start: 'dyndatetime(y,m,23)', end: 'dyndatetime(y,m,30)', resource: 4, color: 'pink' },
            ...
            { title: 'Event 31', start: 'dyndatetime(y,m,2)', end: 'dyndatetime(y,m,7)', resource: 14, color: 'green' },
          ...
          renderHeader: function () {
            return (
              ...
              '<button mbsc-button data-start-icon="material-list" data-variant="flat" data-color="dark" class="mds-reorder-switch mds-enable">Reorder resources</button>' +
              '<button mbsc-button class="mds-reorder-save mds-update mds-hidden">Save resource order</button>' +
              '<button mbsc-button class="mds-reorder-cancel mds-update mds-hidden">Cancel</button>' +
