...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/switching-day-week-work-week-timeline#).
...
- **Want to see how to set other views?** [Check out this example for switching views &#8594;](https://demo.mobiscroll.com/jquery/scheduler/switching-calendar-scheduler-agenda#)
