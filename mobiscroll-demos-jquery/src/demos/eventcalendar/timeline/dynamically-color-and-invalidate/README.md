...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/dynamically-color-and-invalidate#).
...
- **Want to learn about lifecycle events?** [Learn how you can levarage the various events that are triggered &#8594;](https://demo.mobiscroll.com/jquery/timeline/event-hooks#)
