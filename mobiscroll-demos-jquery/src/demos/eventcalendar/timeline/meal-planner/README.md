...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/meal-planner#).

## Demo description

Use the [timeline summary mode/event listing](https://demo.mobiscroll.com/jquery/timeline/event-listing#) to create a weekly meal planner. Meal types are represented as resources with a [custom template](https://demo.mobiscroll.com/jquery/scheduler/custom-resource-header-template#). Events are the actual meals with custom properties, like calories or notes.
