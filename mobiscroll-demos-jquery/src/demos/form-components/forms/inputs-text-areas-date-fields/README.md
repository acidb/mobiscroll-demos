...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/forms/inputs-text-areas-date-fields#).
...
Play around and combine different [input types with various label positions](https://demo.mobiscroll.com/jquery/forms/input-label-types#) to find out what fits you best.
