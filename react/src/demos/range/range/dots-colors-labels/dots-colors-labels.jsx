        ...
        <div className="mbsc-row">
          <div className="mbsc-col-sm-12 mbsc-col-md-4">
            <div className="mbsc-form-group">
              ...
              <Datepicker controls={['calendar']} select="range" showRangeLabels={false} display="inline" marked={marked} />
            </div>
          </div>
          <div className="mbsc-col-sm-12 mbsc-col-md-4">
            <div className="mbsc-form-group">
              <div className="mbsc-form-group-title">Colored days</div>
              <Datepicker controls={['calendar']} select="range" showRangeLabels={false} display="inline" colors={colors} />
            </div>
          </div>
          <div className="mbsc-col-sm-12 mbsc-col-md-4">
            <div className="mbsc-form-group">
              <div className="mbsc-form-group-title">Labels</div>
              <Datepicker controls={['calendar']} select="range" showRangeLabels={false} display="inline" labels={labels} />
            </div>
          </div>
        </div>
      </div>
