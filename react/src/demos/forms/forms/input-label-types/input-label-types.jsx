...
//<demo-only>import { setOptions, Page, Input, Textarea, Dropdown/* localeImport */ } from '@mobiscroll/react';//</demo-only>
        ...
        <div className="mbsc-row mbsc-justify-content-center">
          <div className="mbsc-col-sm-12 mbsc-col-md-8 mbsc-col-xl-4">
            <div className="mbsc-form-group">
              ...
              <Input inputStyle="underline" labelStyle="stacked" startIcon="user4" placeholder="Input with label" label="Name"></Input>
              <Input
        ...
        <div className="mbsc-row mbsc-justify-content-center">
          <div className="mbsc-col-sm-12 mbsc-col-md-8 mbsc-col-xl-4">
            <div className="mbsc-form-group">
              ...
              <Input inputStyle="box" labelStyle="stacked" startIcon="user4" placeholder="Input with label" label="Name"></Input>
              <Input
                inputStyle="box"
                labelStyle="stacked"
                startIcon="material-email"
          ...
          <div className="mbsc-col-sm-12 mbsc-col-md-8 mbsc-col-xl-4">
            <div className="mbsc-form-group">
              ...
              <Input inputStyle="box" labelStyle="inline" startIcon="user4" placeholder="Input with label" label="Name"></Input>
              <Input
                inputStyle="box"
                labelStyle="inline"
                startIcon="material-email"
          ...
          <div className="mbsc-col-sm-12 mbsc-col-md-8 mbsc-col-xl-4">
            <div className="mbsc-form-group">
              ...
              <Input inputStyle="box" labelStyle="floating" startIcon="user4" placeholder="Input with label" label="Name"></Input>
              <Input
                inputStyle="box"
                labelStyle="floating"
                startIcon="material-email"
