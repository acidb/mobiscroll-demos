...
//<demo-only>import { Eventcalendar, Page, Button, getJson/* localeImport */ } from '@mobiscroll/react';
...
function App() {
    ...
    React.useEffect(() => {
        getJson('https://trial.mobiscroll.com/daily-weekly-events/', (events: MbscCalendarEvent[]) => {
            setEvents(events);
        }, 'jsonp');
    }, []);
