          ...
          .eventcalendar({
            ...
            renderHeader: function () {
              return (
                ...
                '<label><input data-icon="calendar" mbsc-segmented type="radio" name="custom-header-view" value="calendar" class="md-custom-header-view-change" checked></label>' +
                '<label><input data-icon="material-list" mbsc-segmented type="radio" name="custom-header-view" value="schedule" class="md-custom-header-view-change"></label>' +
                '</div>'
              );
            },
          })
