...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/timeline/resource-background#).
...
- **Interested in highlighting date ranges only?** [Explore this example &#8594;](https://demo.mobiscroll.com/vue/timeline/colors-invalids-css-class#)

## Related demos

- [Explore this example &#8594;](https://demo.mobiscroll.com/vue/timeline/colors-invalids-css-class#)
