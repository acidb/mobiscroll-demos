...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/timeline/work-order-scheduling#).
...
You can use the
[date header template](https://demo.mobiscroll.com/vue/timeline/hour-day-week-month-quarter-year-header-footer-template#)
and add a simple
[event template](https://demo.mobiscroll.com/vue/timeline/timeline-custom-event-rendering#)
