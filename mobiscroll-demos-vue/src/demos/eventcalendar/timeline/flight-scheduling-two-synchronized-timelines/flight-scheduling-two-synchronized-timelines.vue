...
const invalid = ref([])
const firstCalCont = ref(null)
const secondCalCont = ref(null)
const skipScroll1 = ref(false)
const skipScroll2 = ref(false)
...
function handleEventDragStart(args) {
  const unavailable = {}
  const inv = {
