...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/timeline/load-events-on-demand#).

## Demo description

The timeline supports [remote](https://demo.mobiscroll.com/vue/timeline/load-events-from-remote-api#) and [local data sources](https://demo.mobiscroll.com/vue/timeline/load-inline-data#). Besides that, events can be populated on initialization or loaded on demand.
