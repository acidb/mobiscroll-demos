...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/timeline/dynamic-calculation-resource-sort#).
...
[snackbar](https://demo.mobiscroll.com/vue/forms/notifications#)
