...
- **Want to learn about lifecycle events?** [Learn how you can levarage the various events that are triggered &#8594;](https://demo.mobiscroll.com/vue/timeline/event-hooks#)
