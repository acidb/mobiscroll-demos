...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/timeline/monthly-timetable-vertical-days-horizontal-times#).

## Demo description

While the timeline is great for [working with many resources](https://demo.mobiscroll.com/vue/timeline/loading-big-data-sets#)
...
- **Want to learn about how you can configure the horizontal and vertical resolution?** [Play around with this example &#8594;](https://demo.mobiscroll.com/vue/timeline/multiple-days-weeks-months-quarters-years-variable-resolution#)

## Related demos

- [Play around with this example &#8594;](https://demo.mobiscroll.com/vue/timeline/multiple-days-weeks-months-quarters-years-variable-resolution#)
