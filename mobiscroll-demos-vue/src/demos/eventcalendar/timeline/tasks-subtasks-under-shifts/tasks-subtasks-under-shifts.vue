...
const timelineInst = ref(null)
const myInvalids = ref(blockedOutTimes)
...
const handelEventCreate = (args, inst) => {
...
const handelEventDragStart = (args, inst) => {
...
const handelEventUpdate = (args, inst) => {
  const newEventList = [...myEvents.value]
  const event = args.event
...
const handelEventUpdateFailed = (args) => {
