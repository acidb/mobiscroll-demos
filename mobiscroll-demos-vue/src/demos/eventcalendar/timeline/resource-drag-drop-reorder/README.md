...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/timeline/resource-drag-drop-reorder#).
...
When a resource is dropped into a new position, the @resource-order-update
