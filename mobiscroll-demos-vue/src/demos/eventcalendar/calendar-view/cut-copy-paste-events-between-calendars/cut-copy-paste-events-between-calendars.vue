...
const activeCalendar = ref('first')
const cutCalendar = ref('first')
const toDate = ref(today)
const firstToDate = ref(today)
const secondToDate = ref(today)
const originDate = ref(today)
const isMenuOpen = ref(false)
const selectedEvents = ref([])
const moveEvents = ref([])
const pastedEvents = ref([])
...
const dummyElm = ref(null)
const menuElm = ref(null)
const firstSelectedEvents = ref([])
const secondSelectedEvents = ref([])
...
function handleCellRightClick(args) {
  if (!isMenuOpen.value) {
...
function handleFirstSelectedEventsChange(args) {
  firstSelectedEvents.value = args.events
}

function handleSecondSelectedEventsChange(args) {
