...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/eventcalendar/event-bulk-actions-edit-delete-update#).
...
- **Interested in moving events between two separate calendars?** [Check out the next example for cut, copy, paste events &#8594;](https://demo.mobiscroll.com/vue/eventcalendar/cut-copy-paste-events-between-calendars#)

## Related demos

- [Check out the next example for cut, copy, paste events &#8594;](https://demo.mobiscroll.com/vue/eventcalendar/cut-copy-paste-events-between-calendars#)
