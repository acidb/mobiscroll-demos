...
The Datepicker updates the `selectedDate` option of the Calendar in its @change event, while the Calendar updates the datepicker value from its @selected-date-change event.
