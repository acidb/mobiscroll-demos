...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/eventcalendar/load-events-on-demand#).

## Demo description

The event calendar supports [remote](https://demo.mobiscroll.com/vue/eventcalendar/load-events-from-remote-api#) and [local data sources](https://demo.mobiscroll.com/vue/eventcalendar/load-inline-data#). Besides that, events can be populated on initialization or loaded on demand.
...
Use the `page-loading`
 ...
 lifecycle event to load the data runtime. You can [learn about lifecycle events](https://demo.mobiscroll.com/vue/eventcalendar/event-hooks#) and places where to drop logic to customize the experience.

- **Interested in loading events from Google Calendar?** [Show events from Google Calendar &#8594;](https://demo.mobiscroll.com/vue/eventcalendar/load-events-from-google-calendar#)

## Related demos

- [Show events from Google Calendar &#8594;](https://demo.mobiscroll.com/vue/eventcalendar/load-events-from-google-calendar#)
