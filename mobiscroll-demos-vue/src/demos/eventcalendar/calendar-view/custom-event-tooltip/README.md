...
In case of md-boostrap, you can add the tooltip directive to the [custom event template](https://demo.mobiscroll.com/vue/eventcalendar/customize-label-look-and-feel#)
