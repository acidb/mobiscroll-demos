...
The scheduler supports [remote](https://demo.mobiscroll.com/vue/scheduler/load-events-from-remote-api#) and [local data sources](https://demo.mobiscroll.com/vue/scheduler/load-inline-data#). Besides that, events can be populated on initialization or loaded on demand.
...
Use the `page-loading`
 ...
 lifecycle event to load the data runtime. You can [learn about lifecycle events](https://demo.mobiscroll.com/vue/scheduler/event-hooks#) and places where to drop logic to customize the experience.
...
- [Show events from Google Calendar &#8594;](https://demo.mobiscroll.com/vue/scheduler/load-events-from-google-calendar#)
