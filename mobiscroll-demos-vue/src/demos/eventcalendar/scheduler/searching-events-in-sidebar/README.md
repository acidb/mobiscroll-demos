...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/scheduler/searching-events-in-sidebar#).

## Demo description

Inline search can be easily implemented with the help of a separate [agenda](https://demo.mobiscroll.com/vue/agenda/#) instance.
...
[Events can be filtered in real time](https://demo.mobiscroll.com/vue/scheduler/resource-filtering-in-header#) so using an agenda view for the search results is an easy choice.
...
[agenda listed in a popup](https://demo.mobiscroll.com/vue/eventcalendar/searching-events-in-popup#) instead of rendered inline.
