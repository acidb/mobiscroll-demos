...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/scheduler/colors-invalids-css-class#).

## Demo description

Besides [customizing the background color](https://demo.mobiscroll.com/vue/scheduler/colored-cell-background#)
of cells and
[setting up invalid/blocked out times](https://demo.mobiscroll.com/vue/scheduler/time-off-blocked-ranges#)
