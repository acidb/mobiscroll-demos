...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/scheduler/time-off-blocked-ranges#).
...
- To disable weekends, use the [recurring object](https://demo.mobiscroll.com/vue/scheduler/recurring-events#) - `recurring: { repeat: 'weekly', weekDays: 'SA,SU' }`
...
- **Want to prevent double booking?** [Learn how to manage event overlaps &#8594;](https://demo.mobiscroll.com/vue/scheduler/prevent-double-booking-events#)

## Related demos

- [Learn how to manage event overlaps &#8594;](https://demo.mobiscroll.com/vue/scheduler/prevent-double-booking-events#)
