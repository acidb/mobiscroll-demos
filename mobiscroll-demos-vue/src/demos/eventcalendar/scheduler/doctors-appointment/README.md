...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/scheduler/doctors-appointment#).
...
Enabling [advanced validation](https://demo.mobiscroll.com/vue/scheduler/time-off-blocked-ranges#) and combining that with the
[drag & drop between the calendar and external list](https://demo.mobiscroll.com/vue/scheduler/external-drag-drop-sortable-dragula#)
