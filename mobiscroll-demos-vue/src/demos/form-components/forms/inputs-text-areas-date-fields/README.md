...
Play around and combine different [input types with various label positions](https://demo.mobiscroll.com/vue/forms/input-label-types#) to find out what fits you best.
