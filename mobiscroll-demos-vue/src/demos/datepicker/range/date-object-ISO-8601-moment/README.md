...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/range/date-object-ISO-8601-moment#).
...
When passing dates to the component - eg. [invalids](https://demo.mobiscroll.com/vue/range/disabled-invalid-values#), [min/max](https://demo.mobiscroll.com/vue/datetime/min-max-restrictions#) - you can do it in either format and the picker will automatically know what to do with it. If you want to specify how the picker should return values, you can do it in the `returnFormat` option.
