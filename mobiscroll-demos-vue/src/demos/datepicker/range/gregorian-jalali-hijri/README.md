...
- **Interested in localization?** [Explore this example →](https://demo.mobiscroll.com/vue/range/localization#)

## Related demos

- [Explore this example →](https://demo.mobiscroll.com/vue/range/localization#)
