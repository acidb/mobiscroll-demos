...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/range/customize-marked-day-shapes#).
...
- **What else can you use to add extra information to the day cells?** [Learn how to add labels and color days →](https://demo.mobiscroll.com/vue/range/dots-colors-labels#)

## Related demos

- [Learn how to add labels and color days →](https://demo.mobiscroll.com/vue/range/dots-colors-labels#)
