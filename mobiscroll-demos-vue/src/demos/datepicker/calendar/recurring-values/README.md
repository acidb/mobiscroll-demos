...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/calendar/recurring-values#).
...
- **Interested in disabling dates?** [Discover how invalids work →](https://demo.mobiscroll.com/vue/calendar/disabled-invalid-values#)

## Related demos

- [Discover how invalids work →](https://demo.mobiscroll.com/vue/calendar/disabled-invalid-values#)
