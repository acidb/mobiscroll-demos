...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/vue/datetime/setting-the-picker-timezone#).
...
[Invalid date-times](https://demo.mobiscroll.com/vue/datetime/disabled-invalid-values#) will be interpreted in `dataTimezone` when they contain no timezone info and will be shown in `displayTimezone` on the wheels.
